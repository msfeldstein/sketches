(function(global, factory) {
    ...
    (function(_PerspectiveCamera) {
      ...
      function LensCamera() {
        ...
        _this = _possibleConstructorReturn(
          this,
          (_getPrototypeOf2 = _getPrototypeOf(LensCamera)).call.apply(
            _getPrototypeOf2,
            [this].concat(args)
          )
        );
      ...
      _createClass(LensCamera, [
        {
          ...
          value: function copy(source, recursive) {
            _get(_getPrototypeOf(LensCamera.prototype), "copy", this).call(
              this,
              source,
              recursive
            );
  ...
  var SoftDirectionalLight =
    ...
    (function(_DirectionalLight) {
      ...
      function SoftDirectionalLight(color, intensity) {
        ...
        _this = _possibleConstructorReturn(
          this,
          _getPrototypeOf(SoftDirectionalLight).call(this, color, intensity)
        );
      ...
      _createClass(SoftDirectionalLight, [
        {
          ...
          value: function copy(source) {
            _get(
              _getPrototypeOf(SoftDirectionalLight.prototype),
              "copy",
              this
            ).call(this, source);
  ...
  var EnvironmentLight =
    ...
    (function(_Light) {
      ...
      function EnvironmentLight(map) {
        ...
        _this = _possibleConstructorReturn(
          this,
          (_getPrototypeOf2 = _getPrototypeOf(EnvironmentLight)).call.apply(
            _getPrototypeOf2,
            [this].concat(args)
          )
        );
      ...
      _createClass(EnvironmentLight, [
        {
          ...
          value: function copy(source) {
            _get(
              _getPrototypeOf(EnvironmentLight.prototype),
              "copy",
              this
            ).call(this, source);
  ...
  var RayTracingMaterial =
    ...
    (function(_MeshStandardMaterial) {
      ...
      function RayTracingMaterial() {
        ...
        _this = _possibleConstructorReturn(
          this,
          (_getPrototypeOf2 = _getPrototypeOf(RayTracingMaterial)).call.apply(
            _getPrototypeOf2,
            [this].concat(args)
          )
        );
      ...
      _createClass(RayTracingMaterial, [
        {
          ...
          value: function copy(source) {
            _get(
              _getPrototypeOf(RayTracingMaterial.prototype),
              "copy",
              this
            ).call(this, source);
  ...
  function loadExtensions(gl, extensions) {
    ...
    try {
      for (
        var _iterator = extensions[Symbol.iterator](), _step;
  ...
  function getUniformBlockInfo(gl, program, blockIndex) {
    var indices = gl.getActiveUniformBlockParameter(
      program,
      blockIndex,
      gl.UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES
    );
    var offset = gl.getActiveUniforms(program, indices, gl.UNIFORM_OFFSET);
    var stride = gl.getActiveUniforms(
      program,
      indices,
  ...
  function mergeMeshesToGeometry(meshes) {
    ...
    try {
      for (
        var _iterator = meshes[Symbol.iterator](), _step;
        !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
        _iteratorNormalCompletion = true
      ) {
        var mesh = _step.value;

        var _geometry = cloneBufferGeometry(mesh.geometry, [
          "position",
          "normal",
          "uv"
        ]);
    ...
    var _mergeGeometry = mergeGeometry(
  ...
  function mergeGeometry(geometryAndMaterialIndex, vertexCount, indexCount) {
    var position = new THREE$1.BufferAttribute(
      new Float32Array(3 * vertexCount),
      3,
      false
    );
    var normal = new THREE$1.BufferAttribute(
      new Float32Array(3 * vertexCount),
      3,
      false
    );
    var uv = new THREE$1.BufferAttribute(
      new Float32Array(2 * vertexCount),
      2,
      false
    );
    var index = new THREE$1.BufferAttribute(
    ...
    try {
      for (
        var _iterator2 = geometryAndMaterialIndex[Symbol.iterator](), _step2;
  ...
  function cloneBufferGeometry(bufferGeometry, attributes) {
    ...
    try {
      for (
        var _iterator3 = attributes[Symbol.iterator](), _step3;
    ...
    if (nPrimitives === 1) {
      ...
      if (nPrimitives <= 4) {
        ...
        for (var _i4 = start; _i4 < end; _i4++) {
          var b = Math.floor(
            buckets.length *
              boxOffset(centroidBounds, dim, primitiveInfo[_i4].center)
          );
  ...
  function numberArraysEqual(a, b) {
    var eps =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1e-4;
  ...
  function addLightAtCoordinates(light, image, originCoords) {
    ...
    var intensityFromAngleFunction = useThreshold
    ...
    for (var i = 0; i < xTexels; i++) {
      ...
      for (var j = 0; j < yTexels; j++) {
        ...
        var falloff = intensityFromAngleFunction(
          originCoords,
          currentCoords,
          softness,
          threshold
  ...
  function getFalloffAtAngle(angle, softness) {
    var softnessCoefficient = Math.pow(
      2,
  ...
  function getTexturesFromMaterials(meshes, textureNames) {
    ...
    try {
      for (
        var _iterator = textureNames[Symbol.iterator](), _step;
        !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
        _iteratorNormalCompletion = true
      ) {
        var name = _step.value;
  ...
  function mergeTexturesFromMaterials(meshes, textureNames) {
    ...
    try {
      for (
        var _iterator2 = textureNames[Symbol.iterator](), _step2;
        !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
        _iteratorNormalCompletion2 = true
      ) {
  ...
  function texturesFromMaterials(materials, textureName, textures) {
    ...
    try {
      for (
        var _iterator3 = materials[Symbol.iterator](), _step3;
        !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done);
        _iteratorNormalCompletion3 = true
      ) {
  ...
  function makeTexture(gl, params) {
    var _params$width = params.width,
      ...
      gammaCorrection =
        _params$gammaCorrecti === void 0 ? false : _params$gammaCorrecti,
  ...
  function uploadBuffers(gl, program, bufferData) {
    ...
    var _bufferData$color = bufferData.color,
      ...
      normalScale =
        _bufferData$normalSca === void 0 ? [] : _bufferData$normalSca,
      ...
      diffuseMapIndex =
        _bufferData$diffuseMa === void 0 ? [] : _bufferData$diffuseMa,
      _bufferData$diffuseMa2 = bufferData.diffuseMapSize,
      diffuseMapSize =
        _bufferData$diffuseMa2 === void 0 ? [] : _bufferData$diffuseMa2,
      _bufferData$normalMap = bufferData.normalMapIndex,
      normalMapIndex =
        _bufferData$normalMap === void 0 ? [] : _bufferData$normalMap,
      _bufferData$normalMap2 = bufferData.normalMapSize,
      normalMapSize =
        _bufferData$normalMap2 === void 0 ? [] : _bufferData$normalMap2,
      _bufferData$roughness2 = bufferData.roughnessMapIndex,
      roughnessMapIndex =
        _bufferData$roughness2 === void 0 ? [] : _bufferData$roughness2,
      _bufferData$metalness2 = bufferData.metalnessMapIndex,
      metalnessMapIndex =
        _bufferData$metalness2 === void 0 ? [] : _bufferData$metalness2,
      _bufferData$pbrMapSiz = bufferData.pbrMapSize,
      pbrMapSize =
        _bufferData$pbrMapSiz === void 0 ? [] : _bufferData$pbrMapSiz;
    materialBuffer.set(
    ...
    materialBuffer.set(
      ...
      interleave(
        ...
        {
          data: (_ref2 = []).concat.apply(
            _ref2,
            _toConsumableArray(
              normalScale.map(function(d) {
                return d.toArray();
              })
            )
          ),
  ...
  */
  function makeStratifiedSamplerCombined(strataCount, listOfDimensions) {
    ...
    try {
      for (
        var _iterator = listOfDimensions[Symbol.iterator](), _step;
        !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
        _iteratorNormalCompletion = true
      ) {
        var dim = _step.value;
    ...
    function next() {
      ...
      for (
        var _i = 0, _strataObjs = strataObjs;
        _i < _strataObjs.length;
        _i++
      ) {
        ...
        try {
          for (
            var _iterator2 = nums[Symbol.iterator](), _step2;
            !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
            _iteratorNormalCompletion2 = true
          ) {
    ...
    function restart() {
      for (
        var _i2 = 0, _strataObjs2 = strataObjs;
        _i2 < _strataObjs2.length;
        _i2++
      ) {
  ...
  function makeProgramFromScene(_ref2) {
    ...
    var pbrMap = mergeTexturesFromMaterials(materials, [
      "roughnessMap",
      "metalnessMap"
    ...
    if (maps.normalMap.textures.length > 0) {
      var _makeTextureArray2 = makeTextureArray$1(
          gl,
    ...
    var envImage = generateEnvMapFromSceneComponents(
      directionalLights,
      environmentLights
    );
    textureAllocator.bind(
  ...
  function maxImageSize(images) {
    ...
    try {
      for (
        var _iterator2 = images[Symbol.iterator](), _step2;
        !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
        _iteratorNormalCompletion2 = true
      ) {
  ...
  function fragString$1(defines) {
    return "#version 300 es\n\nprecision mediump float;\nprecision mediump int;\n\nin vec2 vCoord;\n\nout vec4 fragColor;\n\nuniform sampler2D image;\n\n"
      ...
      .concat(defines.exposure, "; // exposure\n\n  light = ")
      .concat(
        defines.toneMapping,
  ...
  var toneMapFunctions =
    ((_toneMapFunctions = {}),
    _defineProperty(_toneMapFunctions, THREE$1.LinearToneMapping, "linear"),
    _defineProperty(_toneMapFunctions, THREE$1.ReinhardToneMapping, "reinhard"),
    _defineProperty(
      _toneMapFunctions,
      THREE$1.Uncharted2ToneMapping,
      "uncharted2"
    ),
    _defineProperty(_toneMapFunctions, THREE$1.CineonToneMapping, "cineon"),
    _defineProperty(
      _toneMapFunctions,
      THREE$1.ACESFilmicToneMapping,
      "acesFilmic"
    ),
    _toneMapFunctions);
  function makeToneMapShader(params) {
    var fullscreenQuad = params.fullscreenQuad,
      gl = params.gl,
      optionalExtensions = params.optionalExtensions,
    ...
    var uniforms = getUniforms(gl, program);
    var image = textureAllocator.reserveSlot();
  ...
  function makeFramebuffer(params) {
    var gl = params.gl,
      _params$linearFilteri = params.linearFiltering,
      linearFiltering =
        _params$linearFilteri === void 0 ? false : _params$linearFilteri,
  ...
  function initSingleTexture(gl, width, height, linearFiltering, _ref) {
  ...
  function initMultipleTextures(
    ...
    try {
      for (
        var _iterator = renderTargets.targets[Symbol.iterator](), _step;
        !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
        _iteratorNormalCompletion = true
      ) {
        var _step$value = _step.value,
          name = _step$value.name,
          storage = _step$value.storage,
  ...
  function makeTextureAllocator(gl) {
    ...
    function reserveSlot() {
      var unit = nextUnit++;
      return {
        bind: function bind(uniform, textureObj) {
  ...
  function makeRenderingPipeline(_ref) {
    ...
    var useLinearFiltering = optionalExtensions.OES_texture_float_linear; // full resolution buffer representing the rendered scene with HDR lighting

    var hdrBuffer = makeFramebuffer({
      gl: gl,
      renderTarget: {
        storage: "float"
      }
    ...
    var hdrPreviewBuffer = makeFramebuffer({
      gl: gl,
      renderTarget: {
        storage: "float"
      },
      useLinearFiltering: useLinearFiltering
